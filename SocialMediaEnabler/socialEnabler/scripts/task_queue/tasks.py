...
def process_values(message):
    ...
    # TODO add the process functionality
    return save_on_couchbase.delay(message).task_id

@app.task
def sentiment_train():
    # TODO copy ideas for percentage of completion on training http://blog.miguelgrinberg.com/post/using-celery-with-flask
    return True