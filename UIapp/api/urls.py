...
urlpatterns = patterns('',
                       ...
                       url(r'^project/(\d+)/report/dailyhistogram$', views.histogram_daily_report_per_topic_per_influencer, name='project daily histogram per topic per account'),
                       url(r'^project/(\d+)/report/popular_hashtags$', views.most_popular_hashtags, name='popular hashtags'),
